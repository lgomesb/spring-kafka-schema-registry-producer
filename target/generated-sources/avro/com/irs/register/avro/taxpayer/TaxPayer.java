 ...
 */
package com.irs.register.avro.taxpayer;
...
public class TaxPayer extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.irs.register.avro.taxpayer.TaxPayer.Builder newBuilder() {
    return new com.irs.register.avro.taxpayer.TaxPayer.Builder();
  }
   ...
   * @return A new TaxPayer RecordBuilder
   */
  public static com.irs.register.avro.taxpayer.TaxPayer.Builder newBuilder(com.irs.register.avro.taxpayer.TaxPayer.Builder other) {
    if (other == null) {
      return new com.irs.register.avro.taxpayer.TaxPayer.Builder();
    } else {
      return new com.irs.register.avro.taxpayer.TaxPayer.Builder(other);
    }
  }
   ...
   * @return A new TaxPayer RecordBuilder
   */
  public static com.irs.register.avro.taxpayer.TaxPayer.Builder newBuilder(com.irs.register.avro.taxpayer.TaxPayer other) {
    if (other == null) {
      return new com.irs.register.avro.taxpayer.TaxPayer.Builder();
    } else {
      return new com.irs.register.avro.taxpayer.TaxPayer.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TaxPayer>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.irs.register.avro.taxpayer.TaxPayer.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.irs.register.avro.taxpayer.TaxPayer other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.irs.register.avro.taxpayer.TaxPayer.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.irs.register.avro.taxpayer.TaxPayer.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.irs.register.avro.taxpayer.TaxPayer.Builder setDocument(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.irs.register.avro.taxpayer.TaxPayer.Builder clearDocument() {
      document = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.irs.register.avro.taxpayer.TaxPayer.Builder setSituation(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.irs.register.avro.taxpayer.TaxPayer.Builder clearSituation() {
